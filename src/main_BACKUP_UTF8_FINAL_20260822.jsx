...
function Auth({ onAuth }) {
  ...
  async function submit(e) {
    ...
    try {
      ...
      console.error("Erro de autenticação:", err); setMsg(err?.message || "N�o foi possível concluir.");
  ...
  async function forgot() {
    ...
    } catch (err) { setMsg(err?.message || "N�o foi possível enviar o e-mail."); }
  }
...
function StudentList({ user, onNewStudent, onSelectStudent }) {
  ...
  async function loadStudents() {
    ...
    try {
      ...
      setMsg(error?.message || "N�o foi possível carregar os alunos.");
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="grid">
          {students.map(student => (
            <div className="panel" key={student.id}>
              ...
              <p>
                <strong>CPF:</strong>{" "}
                {student.cpf || "N�o informado"}
              </p>

              <p>
                <strong>Telefone:</strong>{" "}
                {student.phone || "N�o informado"}
              </p>

              <p>
                <strong>Categoria:</strong>{" "}
                {student.category || "N�o informada"}
              </p>

              <p>
                <strong>Aulas planejadas:</strong>{" "}
                {student.lesson_goal ?? "N�o informado"}
              </p>
...
setTimeout(() => {
  onStarted(data);
      ...
      setMsg(error?.message || "N�o foi possível iniciar a aula.");
    } finally {
      setBusy(false);
    }
  }
...
function LessonRunning({ user, lesson, onCompleted, onBack, readOnly = false }) {
  ...
  async function updateLesson(patch, successMessage) {
    ...
    try {
      ...
      setMessage(error?.message || "N�o foi possível atualizar a aula.");
      return null;
    } finally {
      setBusy(false);
    }
...
function LessonHistory({ user, onBack, onSelect }) {
  ...
  async function loadLessons() {
    ...
    try {
      ...
      setMsg(error?.message || "N�o foi possível carregar o histórico de aulas.");
    } finally {
      setLoading(false);
    }
  }
            ...
            return (
              <div className="panel" key={lesson.id} style={{
                ...
                <div style={{
                  ...
                  {lesson.objective || "N�o informado"}
                </div>
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: "11px 10px", maxWidth: "180px" }}>
                      <div>{vehicle ? `${vehicle.brand || ""} ${vehicle.model || ""}`.trim() : "N�o informado"}</div>
                      {vehicle?.plate && (
                        <div style={{ fontSize: "10px", opacity: 0.65 }}>
                          {vehicle.plate}
                        </div>
    ...
    <div style={{ width: "100%", maxWidth: "1400px", margin: "0 auto", boxSizing: "border-box" }}>
      ...
      <section className="panel" style={{ margin: 0, minWidth: 0 }}>
        <div style={{
          ...
          <div style={{ padding: "4px 6px" }}>
            ...
            <div style={{ fontSize: "20px", fontWeight: 800, marginTop: "5px" }}>
              {student?.full_name || "N�o informado"}
            </div>
        ...
        <div style={{
          ...
          <span><strong>KM inicial:</strong> {lesson.km_start ?? "N�o informado"}</span>
          <span><strong>KM final:</strong> {lesson.km_end ?? "N�o informado"}</span>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    {pedagogicalDiagnosis || "N�o informado."}
                  </p>
                </div>
              </div>
            )}
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      {nextLessonRecommendation || "N�o informada."}
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      {nextLessonObjective || "N�o informado."}
                    </div>
                  </div>
                </div>
              </div>
...
function StudentForm({ user, onBack }) {
  ...
  async function saveStudent(e) {
    ...
    try {
      ...
      setMsg(error?.message || "N�o foi possível cadastrar o aluno.");
    } finally {
      setBusy(false);
    }
  }
...
if (tab === "financeiro") {
  ...
  async function saveFinanceEntry(event) {
    ...
    if (error) {
      ...
      alert("NÃ£o foi possÃ­vel salvar o lançamento: " + error.message);
      return;
    }
  ...
  async function deleteFinanceEntry(id) {
    ...
    if (error) {
      ...
      alert("NÃ£o foi possÃ­vel excluir o lançamento: " + error.message);
      return;
    }
            ...
            <div className="grid">
              ...
              <label>
                ...
                >
                  ...
                  <option value="CombustÃ­vel">Combust&iacute;vel</option>
                  <option value="ManutenÃ§Ã£o">Manuten&ccedil;&atilde;o</option>
            ...
            <div className="grid">
              ...
              <label>
                ...
                >
                  ...
                  <option value="CartÃ£o">Cart&atilde;o</option>
                  <option value="TransferÃªncia">Transfer&ecirc;ncia</option>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <small>
                      ...
                      {account.agency
                        ? ` â€¢ Agência ${account.agency}`
                        : ""}
                      {account.account_number
                        ? ` â€¢ Conta ${account.account_number}`
                        : ""}
                    </small>
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        ...
        if (active) setMsg(error?.message || "N�o foi possível carregar os dados do HSI-DOTH-P.");
      } finally {
...
function ProfileForm({ user }) {
  ...
  useEffect(() => {
    ...
    async function loadProfile() {
      ...
      if (error) {
        setMsg(error.message || "N�o foi possível carregar o perfil.");
      } else if (!data) {
  ...
  async function saveProfile(e) {
    ...
    try {
      ...
      setMsg(error?.message || "N�o foi possível salvar o cadastro.");
    } finally {
      setBusy(false);
    }
  }
      ...
      <form onSubmit={saveProfile}>
        ...
        <div className="panel">
          ...
          <input
            ...
            placeholder="N�mero da credencial"
          />
...
other_annual: (
  ...
  Number(form.other_costs_year || 0)
      ...
      setMsg(error?.message || "N�o foi possível cadastrar o veículo.");
    } finally {
      setBusy(false);
    }
  }
