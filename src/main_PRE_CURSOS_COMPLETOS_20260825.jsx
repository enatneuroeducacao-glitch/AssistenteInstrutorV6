...
if (tab === "rpa") {
  return (
    ...
    if (tab === "cursos") {
      return <CoursesPage onBack={() => setTab("dashboard")} />;
    }
...
function CoursesPage({ onBack }) {
  ...
  const courses = [
    {
      id: "neuroeducacao",
      icon: "🧠",
      title: "Neuroeducação Aplicada ao Trânsito",
      category: "Aprofundamento",
      description:
        "Aprofunde conhecimentos sobre aprendizagem, atenção, memória, emoções e comportamento aplicados à formação de condutores.",
      modules: [
        "Fundamentos da neuroeducação",
        "Atenção e memória no processo de aprendizagem",
        "Emoções e tomada de decisão",
        "Neurociência aplicada à condução",
        "Estratégias neuroeducacionais para aulas práticas",
        "Aplicação pedagógica no cotidiano do instrutor"
      ]
    },
    {
      id: "fatores-humanos",
      icon: "👤",
      title: "Fatores Humanos no Trânsito",
      category: "Aprofundamento",
      description:
        "Estude os principais fatores humanos relacionados ao comportamento do condutor e à segurança viária.",
      modules: [
    ...
    },
    {
      id: "hsi-doth-p",
      icon: "📊",
      title: "HSI-DOTH-P na Prática",
      category: "Especialização",
      description:
        "Aprenda a compreender e utilizar o HSI-DOTH-P como instrumento de acompanhamento dos fatores humanos durante o processo de formação.",
      modules: [
        "Conceito e finalidade do HSI-DOTH-P",
        "Dimensão Decisão",
        "Dimensão Organização",
        "Dimensão Tempo",
        "Dimensão Humanização",
        "Dimensão Psicocomportamental",
    ...
    },
    {
      ...
      icon: "🚗",
      title: "Direção Defensiva e Percepção de Risco",
      category: "Aprofundamento",
      description:
        "Aprofunde técnicas de percepção, antecipação e gerenciamento de riscos durante a condução.",
      modules: [
        "Princípios da direção defensiva",
        "Identificação de riscos",
        "Antecipação de situações críticas",
        "Tomada de decisão",
        "Comportamento preventivo",
        "Aplicação durante a aula prática"
      ]
    },
    {
      id: "metodologia-aula",
      icon: "🎓",
      title: "Metodologia da Aula Prática",
      category: "Pedagógico",
      description:
        "Aprimore a organização, condução e avaliação das aulas práticas de formação de condutores.",
      modules: [
        "Planejamento da aula",
        "Definição de objetivos",
        "Comunicação instrutor-aluno",
        "Feedback pedagógico",
    ...
    },
    {
      ...
      icon: "❤️",
      title: "Inteligência Emocional para Instrutores",
      category: "Desenvolvimento",
      description:
        "Desenvolva estratégias para lidar com emoções, conflitos, ansiedade e situações de pressão durante a formação.",
      modules: [
        "Inteligência emocional",
        "Autorregulação",
        "Ansiedade do aluno",
        "Comunicação assertiva",
        "Conflitos durante a aula",
        "Empatia profissional",
        "Autocuidado do instrutor"
      ]
    }
  ];
  ...
  function sendCourseRequest(event) {
    ...
    const subject = encodeURIComponent(
      "Solicitação de curso específico - Assistente do Instrutor"
    );

    const body = encodeURIComponent(
      "Olá, equipe ENAT.\n\n" +
      "Gostaria de solicitar informações/criação de um curso específico para aprofundamento profissional.\n\n" +
      "Curso desejado:\n\n" +
    ...
    window.location.href =
      `mailto:enat.neuroeducacao@gmail.com?subject=${subject}&body=${body}`;
      ...
      <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
        ...
        <div className="panel" style={{ padding: "28px" }}>
          ...
          >
            ...
            >
              Esta área foi preparada para receber o conteúdo completo de
              cada formação. Os módulos poderão posteriormente conter aulas,
              textos, materiais complementares, avaliações e certificados.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="panel" style={{ padding: "24px" }}>
        ...
        >
          <div>
            ...
            >
              Amplie sua formação, aprofunde conhecimentos e desenvolva
              novas competências para atuar como instrutor de trânsito.
            </p>
          </div>
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              Solicite uma formação específica. A equipe ENAT poderá avaliar
              sua necessidade e desenvolver uma proposta de conteúdo.
            </p>
          </div>
      ...
      {showRequestForm && (
        ...
        >
          ...
          >
            ...
            >
              O formulário abaixo abrirá seu aplicativo de e-mail com a
              solicitação preparada para o endereço institucional ENAT.
            </p>
            ...
            <form onSubmit={sendCourseRequest}>
              <label style={{ display: "block", marginBottom: "14px" }}>
                ...
                <input
                  required
                  placeholder="Ex.: Neuropsicologia aplicada ao trânsito"
              ...
              <label style={{ display: "block", marginBottom: "14px" }}>
                ...
                <textarea
                  required
                  placeholder="Descreva o que gostaria de aprofundar."
                  rows={4}
                  style={{
                    width: "100%",
                    marginTop: "6px",
            ...
            {requestSent && (
              <p className="msg" style={{ marginTop: "14px" }}>
                Solicitação preparada para envio ao e-mail institucional
