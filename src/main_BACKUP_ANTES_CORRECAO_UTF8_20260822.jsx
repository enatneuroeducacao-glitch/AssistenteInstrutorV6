...
if (tab === "financeiro") {
  ...
  async function saveFinanceEntry(event) {
    ...
    if (error) {
      console.error("Erro ao salvar lanÃƒÂ§amento financeiro:", error);
      alert("NÃƒÂ£o foi possÃƒÂ­vel salvar o lanÃƒÂ§amento: " + error.message);
      return;
    }
  ...
  async function deleteFinanceEntry(id) {
    ...
    const confirmed = window.confirm(
      "Deseja realmente excluir este lanÃƒÂ§amento?"
    );
    ...
    if (error) {
      console.error("Erro ao excluir lanÃƒÂ§amento:", error);
      alert("NÃƒÂ£o foi possÃƒÂ­vel excluir o lanÃƒÂ§amento: " + error.message);
      return;
    }
  ...
  async function deleteFinanceAccount(id) {
    ...
    if (error) {
      ...
      alert(
        ...
        "Ela pode possuir lanÃƒÂ§amentos financeiros vinculados."
      );
      return;
    }
    ...
    <>
        ...
        {showFinanceForm && (
          ...
          >
            ...
            <label>
              ...
              <input
                type="text"
                placeholder="Descreva o lanÃƒÂ§amento"
      ...
      <div className="panel">
        ...
        <div style={{
          ...
          <div>
            <h2>Contas bancÃƒÂ¡rias</h2>
            <p>
              Cadastre as contas utilizadas pelo instrutor
              para controlar entradas e saÃƒÂ­das financeiras.
            </p>
          </div>
        ...
        <div style={{
          ...
          {financeAccounts.length === 0 ? (
            ...
            <p>
              Nenhuma conta bancÃƒÂ¡ria cadastrada.
            </p>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <small>
                      ...
                      {account.agency
                        ? ` Ã¢â‚¬Â¢ AgÃƒÂªncia ${account.agency}`
                        : ""}
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        ...
        if (active) setMsg(error?.message || "NÃ£o foi possÃ­vel carregar os dados do HSI-DOTH-P.");
      } finally {
